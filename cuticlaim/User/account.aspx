<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="account.aspx.vb" Inherits="cuticlaim.account" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <div class="container">
        <asp:LinkButton runat="server" ID="btn_changePwd" class="btn btn-primary" Text="<i class='fa fa-save'></i>Change Password" PostBackUrl="/User/pwdEdit.aspx"/>
        <br /><br />
        <div class="row">
            <div class="col-sm-4">
